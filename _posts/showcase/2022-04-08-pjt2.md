...
- 프로젝트 결과 발표시 약 30여명의 강사와 수강생 앞에서 프로젝트 결과의 Live Demo를 진행하였습니다.  
...
1. Plan: Zoom을 사용하여, 매일 3회 팀원과 회의하며 진행도를 점검하고, 문서화된 기록을 남겼습니다.  
...
2. Terraform의 활용;
    ...
    - 이번 미니프로젝트에서는 Ansible로 프로비저닝 하였지만, 추후에는 Terraform으로 진행할 것입니다.
