...
3. 해당 구성을 자주 사용한다면, 어떻게 재사용성을 높일 수 있을까?
    ...
    - 동일한 리소스 파일에 변수값만 다르게하여 빠른 복제 가능
...
2. 반복 생성되는 부분의 코드 단축
    ...
    - 추후 count, for_each, 등 반복문을 배우고 정리

3. 모듈 내 더 많은 리소스 포함
    - 단순히 ALB, EC2 생성 및 연동만 구축하였음
    - Route53 Record 등록, 80>443 HTTPS 적용, EC2 추가볼륨 생성 및 마운트 등 모듈 내 더 많은 리소스 추가 가능
