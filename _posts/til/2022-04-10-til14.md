...
3. Why uses Ansible?
    ...
    - Ansible comes in
        More efficient&Less time consuming in 4ways

        1. Execute task from own machine 
    ...
    4. Agentless
        ...
        If control mach. has ASB and ssh, then the trg serv w/o ASB do work
